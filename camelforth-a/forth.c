...
/* TODO: detect wokwi webbed explicitly */
...
THREAD(scribble) = {Fenter, Tlit, LIT(0x61), Temit, Texit};

/* two variants of Taccept, one for vscode */

THREAD(accept) = {Fenter, Tover, Tplus, Toneminus, Tover,
                  /* 1 */ Tkey, Tdup, Tlit, LIT(NEWLINE), Tnotequal, Tqbranch,
                  OFFSET(27 /*5*/), Tdup, Tlit, LIT(BACKSPACE), Tequal,
                  Tqbranch, OFFSET(12 /*3*/), Tdrop, Tlit, LIT(BACKUP),
                  Tsplemit, Toneminus, Ttor, Tover, Trfrom, Tumax, Tbranch,
                  OFFSET(8 /*4*/),
                  /* 3 */ Tdup,

#ifndef WOKWI_VSCODE
                  /* it is wokwi web */
                  // Temit, // wokwi web only
                  Tdrop, // no echo
#endif                   // #ifndef WOKWI_VSCODE
...
THREAD(type) = {
  Fenter,        Tqdup,           Tqbranch, OFFSET(12 /*4*/), Tover,
  Tplus,         Tswap,           Txdo,
...
THREAD(interpret) = {
  Fenter, Tticksource, Ttwostore, Tzero, Ttoin, Tstore,
  /*1*/ Tbl, Tword, Tdup, Tcfetch, Tqbranch, OFFSET(33 /*9*/), Tfind, Tqdup,
  Tqbranch, OFFSET(14 /*4*/), Toneplus, Tstate, Tfetch, Tzeroequal, Tor,
  Tqbranch, OFFSET(4 /*2*/), Texecute, Tbranch, OFFSET(2 /*3*/),
  /*2*/ Tcommaxt,
  /*3*/ Tbranch, OFFSET(14 /*8*/),
  /*4*/ Tqnumber, Tqbranch, OFFSET(4 /*5*/), Tliteral, Tbranch, OFFSET(8 /*6*/),
...
HEADER(ndump, key, 0, "\005ndump");
HEADER(dump, ndump, 0, "\004dump");
HEADER(emit, dump, 0, "\004emit");
...
HEADER(sdump, dots, 0, "\005sdump");
HEADER(words, sdump, 0, "\005words");
HEADER(cold, words, 0, "\004cold"); // Tue 26 Dec 22:57:09 UTC 2023
